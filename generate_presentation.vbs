...
objTextbox.TextFrame.TextRange.Text = "Supported Platforms:" & vbCrLf & vbCrLf & _
    ...
    "✓ macOS 10.15+" & vbCrLf & _
    "✓ Linux (Ubuntu, Debian)" & vbCrLf & vbCrLf & _
    "Mobile (Limited):" & vbCrLf & _
    "✓ iOS 14+ (no screen share)" & vbCrLf & _
    "✓ Android 9+ (no screen share)" & vbCrLf & vbCrLf & _
    "Browsers:" & vbCrLf & _
    "• Chrome 90+" & vbCrLf & _
    "• Firefox 88+" & vbCrLf & _
    "• Edge 90+" & vbCrLf & _
...
objTextbox.TextFrame.TextRange.Text = "LAN (Local Area Network):" & vbCrLf & vbCrLf & _
    "✓ All devices on same network" & vbCrLf & _
    "✓ No internet required" & vbCrLf & _
    "✓ Faster speeds" & vbCrLf & _
    "✓ More secure" & vbCrLf & _
    "✓ ALL features work" & vbCrLf & vbCrLf & _
    "Access via:" & vbCrLf & _
...
objTextbox.TextFrame.TextRange.Text = "Online (Internet Access):" & vbCrLf & vbCrLf & _
    "✓ Access from anywhere" & vbCrLf & _
    "✓ Requires port forwarding" & vbCrLf & _
    "⚠ Security concerns" & vbCrLf & _
    "⚠ WebRTC limitations" & vbCrLf & vbCrLf & _
    "What Works:" & vbCrLf & _
    "✓ Chat & messaging" & vbCrLf & _
    "✓ File sharing" & vbCrLf & _
    "✓ IoT monitoring" & vbCrLf & vbCrLf & _
    "What May NOT Work:" & vbCrLf & _
    "✗ Video calls (needs TURN)" & vbCrLf & _
...
objTextbox.TextFrame.TextRange.Text = "How to use:" & vbCrLf & _
    ...
    "✓ Desktop: Full features" & vbCrLf & _
    "✓ Mobile: Video/audio only" & vbCrLf & _
    "✗ Mobile: No screen share"
objTextbox.TextFrame.TextRange.Font.Size = 17
...
objTextbox.TextFrame.TextRange.Text = "Best Practices:" & vbCrLf & vbCrLf & _
    "✓ Keep software updated" & vbCrLf & _
    "✓ Use strong passwords" & vbCrLf & _
    "✓ Limit user access" & vbCrLf & _
    "✓ Monitor network traffic" & vbCrLf & _
    "✓ Regular backups" & vbCrLf & vbCrLf & _
...
objTextbox.TextFrame.TextRange.Text = "What We Covered:" & vbCrLf & vbCrLf & _
    "✓ Installation & Setup" & vbCrLf & _
    "✓ Network Configuration" & vbCrLf & _
    "✓ Router Setup" & vbCrLf & _
    "✓ All Application Features" & vbCrLf & _
    "✓ IoT Device Monitoring" & vbCrLf & _
    "✓ Security Considerations" & vbCrLf & _
    "✓ Troubleshooting" & vbCrLf & vbCrLf & _
